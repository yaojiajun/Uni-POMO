...
def validate(model, multiple_width, device, mixed=True):
    ...
    if mixed:
        ...
        # validation dataset
        val_100 = VRPDataset('data/vrp100_test_lkh.pkl', num_samples=1000)
        val_100_loader = DataLoader(val_100, batch_size=1000)
        val_200 = VRPDataset('data/vrp200_test_lkh.pkl', num_samples=1000)
        val_200_loader = DataLoader(val_200, batch_size=1000)
        val_500 = VRPDataset('data/vrp500_test_lkh.pkl', num_samples=100)
        val_500_loader = DataLoader(val_500, batch_size=10)
        val_1000 = VRPDataset('data/vrp1000_test_lkh.pkl', num_samples=100)
        val_1000_loader = DataLoader(val_1000, batch_size=10)
        # validate
        ...
        avg_cost_list = [val_100_cost.cpu().numpy().tolist(), 
                        ...
                        val_1000_cost.cpu().numpy().tolist()]
